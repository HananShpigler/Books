...
class UpdateBookInfo extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios
      ...
      .then((res) => {
        alert.success("The book has been successfully updated");
        this.props.history.push("/show-book/" + this.props.match.params.id);
      })
      .catch((err) => {
        alert.error(
          "Could not update the book, please check the details and try again !"
        );
      });
  };
...
export default withAlert()(UpdateBookInfo);
